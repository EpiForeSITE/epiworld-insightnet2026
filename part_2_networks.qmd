...
2. *Multiple runs*. Look at the documentation of `run_multiple()` and (a) create a saver that extracts the outbreak size, (b) execute the model for the same 50 days, and (c) extract the saved outbreak size and plot the distribution.
